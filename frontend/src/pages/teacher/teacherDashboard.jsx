  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-gray-600">{PLACEHOLDER_DASHBOARD.teacher}</p>
      </div>
      ...
      <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm sm:p-12">
        <div className="mx-auto max-w-md text-center">
          ...
          <p className="mt-2 text-sm leading-relaxed text-gray-600">{PLACEHOLDER_DASHBOARD.teacher}</p>
        </div>
      </div>
    </div>
  );
