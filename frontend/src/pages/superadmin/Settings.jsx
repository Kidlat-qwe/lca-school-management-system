...
const Settings = () => {
  ...
  const canLoadBranch = scope === 'branch' ? Boolean(selectedBranchId) : true;
  ...
  const fetchBranches = async () => {
    try {
      ...
      // Non-blocking: settings can still be edited globally
  ...
  const fetchEffectiveSettings = async () => {
    ...
    try {
      ...
      if (scope === 'branch') params.set('branch_id', selectedBranchId);
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">
                Configure system parameters. First release: Billing / Installments.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                disabled={!canLoadBranch || loading || saving}
