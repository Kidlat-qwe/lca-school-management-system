...
| Tab | Content |
|-----|---------|
| **Teachers** | Personnel-style directory: Name (avatar initial), Email, Phone, Branch, Role, Status |
| **Turnover class** | Current assignment table: Teacher, Branch, Assigned classes, Actions (Class history / Turn over classes) |
...
- Search on both tabs; **program** filter only on **Turnover class**; assigned classes show **See more / See less** (2 visible by default) for even row height
