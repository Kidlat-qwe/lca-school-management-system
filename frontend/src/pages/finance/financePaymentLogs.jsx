...
const FinancePaymentLogs = () => {
  ...
  /** main = pending + approved (excludes Returned/Rejected); return = payments you sent back to the branch; rejected = permanently rejected (excluded from revenue) */
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-sm text-gray-600 max-w-2xl">
            ...
            payments you sent back to the branch for correction. <span className="font-medium text-gray-800">Rejected</span>{' '}
            lists payments that were permanently rejected and excluded from revenue.
          </p>
        </div>
        <button
          type="button"
          ...
          <div className="space-y-2">
            ...
            {dateFilterMode === PAYMENT_LOG_DATE_MODES.PAYMENT_DATE ? (
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  <label
                    htmlFor="finance-payment-date-to"
                    className="mb-1 block text-[10px] font-semibold uppercase tracking-wide text-gray-500"
                  >
                    To
                  </label>
                  <input
                    id="finance-payment-date-to"
                    type="date"
            ...
            {dateFilterMode === PAYMENT_LOG_DATE_MODES.CREATED_DATE ? (
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label
                    htmlFor="finance-created-date-from"
                    className="mb-1 block text-[10px] font-semibold uppercase tracking-wide text-gray-500"
                  >
                    From
                  </label>
                ...
                <div>
                  <label
                    htmlFor="finance-created-date-to"
                    className="mb-1 block text-[10px] font-semibold uppercase tracking-wide text-gray-500"
                  >
                    To
                  </label>
          ...
          <table className="divide-y divide-gray-200 w-full" style={{ tableLayout: 'fixed', minWidth: `${PAYMENT_LOGS_TABLE_MIN_WIDTH_PX}px` }}>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredPayments.length === 0 ? (
                  <tr>
                    <td colSpan={financeLogTab !== 'main' ? 16 : 15} className="px-6 py-12 text-center">
