...
export default function TrackRequestProgressModal({
  ...
  return createPortal(
    <div
      className="fixed inset-0 backdrop-blur-sm bg-black/20 flex items-center justify-center z-[10000] p-4"
      onClick={onClose}
      role="dialog"
      aria-modal="true"
      ...
      >
        ...
        <div className="px-5 py-4 space-y-4">
          <div className="rounded-lg bg-gray-50 border border-gray-100 p-3 space-y-1.5">
            <div className="text-sm font-medium text-gray-900 truncate" title={category}>
              {category}
              {itemName ? (
