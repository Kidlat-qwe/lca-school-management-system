    ...
    <div className="w-full min-w-0 space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">{MONTHLY_OPERATIONAL.pageIntro}</p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          <CombinedStatsCard
            ...
            tooltip={MONTHLY_OPERATIONAL.newEnrolleesReenroll}
          />
          <CombinedStatsCard
            ...
            tooltip={MONTHLY_OPERATIONAL.droppedRejoin}
          />
          <CombinedStatsCard
            ...
            tooltip={MONTHLY_OPERATIONAL.reservedUpsell}
          />
          <CombinedStatsCard
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium text-gray-700">{MONTHLY_OPERATIONAL.merchandiseSection}</p>
          <div className="grid grid-cols-1 items-stretch gap-4 lg:grid-cols-2">
            ...
            <RecentMerchandiseReleasesLog
              ...
              tooltip={MONTHLY_OPERATIONAL.recentMerchandiseReleases}
              emptyMessage="No merchandise releases in this month."
        ...
        <div className="space-y-2">
          <p className="text-sm font-medium text-gray-700">
            {MONTHLY_OPERATIONAL.verificationSection} ({verificationAsOfDisplay})
          </p>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <StatsCard
              ...
              tooltip={MONTHLY_OPERATIONAL.payVerified(formatCurrency(totals.pay_verified_amount || 0))}
            ...
            <StatsCard
              ...
              tooltip={MONTHLY_OPERATIONAL.payNotVerifiedYet(formatCurrency(totals.pay_unverified_amount || 0))}
            ...
            <StatsCard
              ...
              tooltip={MONTHLY_OPERATIONAL.arVerified(formatCurrency(totals.ar_verified_amount || 0))}
            ...
            <StatsCard
              ...
              tooltip={MONTHLY_OPERATIONAL.arUnverified(formatCurrency(totals.ar_unverified_amount || 0))}
        ...
        <div className="rounded-xl border border-indigo-100 bg-indigo-50/60 px-4 py-3">
          <p className="text-xs font-medium text-indigo-800">{MONTHLY_OPERATIONAL.salesGuide}</p>
        </div>
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
          <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">{MONTHLY_OPERATIONAL.branchTable}</p>
            </div>
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
          <ChartCard
            ...
            subtitle={MONTHLY_OPERATIONAL.chartBranchActivity}
          >
          ...
          <ChartCard
            ...
            subtitle={MONTHLY_OPERATIONAL.chartInvoiceByBranch}
          >
            {activeBranchMetrics.length > 0 ? (
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={activeBranchMetrics} margin={{ top: 8, right: 12, left: 0, bottom: 16 }}>
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
          <ChartCard
            ...
            subtitle={MONTHLY_OPERATIONAL.chartSalesTrend}
          ...
          <ChartCard
            title="Activity Mix"
            subtitle={MONTHLY_OPERATIONAL.chartActivityMix}
          >
