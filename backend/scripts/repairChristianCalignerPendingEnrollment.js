/**
 * Christian Alonzo Caligner (student 634) — Phase 1 advance paid for July class,
 * but enrollment stuck on pending_enrollment (June enrolled_at → matrix June pending).
 *
 * Evidence:
 *   - INV-1772 (AR 261437) Phase 1 advance = Paid (2026-06-25)
 *   - Class SOMO_JULY starts 2026-07-01
 *   - classstudent 1417 still pending_enrollment
 *   - Matrix: June pending enrollment, July Active
 *
 * Expected after repair: July = new, August = Active
 *
 * Run:
 *   node backend/scripts/repairChristianCalignerPendingEnrollment.js
 *   node backend/scripts/repairChristianCalignerPendingEnrollment.js --apply
 */
...
const STUDENT_ID = 634;
const CLASS_ID = 115;
const PROFILE_ID = 461;
const PHASE1_INVOICE_ID = 1772;
const CLASSSTUDENT_ID = 1417;
const BRANCH_ID = 3;
const REPAIR_NOTE =
  'Ops repair — promote pending_enrollment after Phase 1 advance paid (INV-1772); new month = July class start';
...
async function main() {
  console.log(
    `\nChristian Caligner — Phase 1 advance → July new${
