/**
 * Mariae Erica Maere F. Fernando (gewellmaefernando@gmail.com) — align Plan 2 (11:00AM Nursery)
 * enrollment statuses for Student History + Month/Phase Re-enrollment matrix.
 *
 * Target (class 53 / profile 414):
 *   Phase 3 → new
 *   Phase 4 → re_enrolled
 *   Phase 5 → re_enrolled
 *
 * Run:
 *   node backend/scripts/repairEricaFernandoPlan2EnrollmentStatuses.js --production
 *   node backend/scripts/repairEricaFernandoPlan2EnrollmentStatuses.js --production --apply
 */
...
const CLASS_ID = 53;
const BRANCH_ID = 6;
const PROFILE_ID = 414;

const REPAIR_NOTE =
  'Ops repair 2026-08-01 — Erica Fernando Plan2 enrollment: Phase3 new, Phase4–5 re_enrolled';
...
const PHASES = [
  {
    ...
    phase: 3,
    status: 'new',
    enrolledAt: '2026-05-07 12:00:00+08',
    clearRemoved: true,
  },
  {
    id: 1185,
    phase: 4,
    status: 're_enrolled',
    enrolledAt: '2026-06-05 12:00:00+08',
    clearRemoved: true,
  },
  {
    id: 1744,
    phase: 5,
    status: 're_enrolled',
    enrolledAt: '2026-07-07 12:00:00+08',
    clearRemoved: true,
  },
...
async function main() {
  console.log(
    `\nErica Fernando — Plan2 enrollment statuses` +
  ...
  try {
    ...
    console.log('\nBEFORE month matrix (Erica track):');
    console.table(beforeMatrix.monthCells);
    console.log('BEFORE phase matrix (Erica track):');
    ...
    console.log('\nAFTER month matrix (Erica track):');
    console.table(afterMatrix.monthCells);
    console.log('AFTER phase matrix (Erica track):');
