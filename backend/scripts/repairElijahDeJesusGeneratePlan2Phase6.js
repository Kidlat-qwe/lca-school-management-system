/**
 * Elijah Mikael A. De Jesus — generate Plan 2 Phase 6 installment invoice + queue.
 *
 * Profile 412 | VMP_NURSERY_TThS_11:00 AM | phase_start 3 | 8 local phases (3–10)
 * Phase 5 INV-1721 is Paid. Phase 6 should be generated:
 *   - issue 2026-07-25, due 2026-08-05
 *   - after generate: next_generation_date 2026-08-25, next_invoice_month 2026-09-01
 *   - generated_count → 4
 *
 * Run:
 *   node backend/scripts/repairElijahDeJesusGeneratePlan2Phase6.js --production
 *   node backend/scripts/repairElijahDeJesusGeneratePlan2Phase6.js --production --apply
 */
...
const REPAIR_NOTE =
  'Ops repair 2026-08-01 — Elijah De Jesus Plan2 generate Phase 6 (Jul 25 / Aug 5); queue → Aug 25 / Sep 01';
...
async function main() {
  console.log(
    `\nElijah De Jesus — Plan2 generate Phase 6${isApply ? ' (APPLY)' : ' (DRY RUN)'}\n`
  );
