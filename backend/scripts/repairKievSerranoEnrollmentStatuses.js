/**
 * Kiev Zion Z. Serrano — align Nursery installment enrollment statuses.
 *
 * Profile 384 | VMM_Nursery_MWF 2:30 PM | class 110
 *   Phase 1 → new (was dropped)
 *   Phase 2 → re_enrolled (was rejoin)
 *
 * Run:
 *   node backend/scripts/repairKievSerranoEnrollmentStatuses.js --production
 *   node backend/scripts/repairKievSerranoEnrollmentStatuses.js --production --apply
 */
...
const REPAIR_NOTE =
  'Ops repair 2026-08-01 — Kiev Serrano enrollment: Phase1 new, Phase2 re_enrolled';
...
const PHASES = [
  {
    ...
    phase: 1,
    status: 'new',
    enrolledAt: '2026-06-02 12:00:00+08',
  },
  {
    id: 1983,
    phase: 2,
    status: 're_enrolled',
    enrolledAt: '2026-07-31 12:00:00+08',
  },
];
...
async function main() {
  console.log(
    `\nKiev Serrano — enrollment statuses${isApply ? ' (APPLY)' : ' (DRY RUN)'}\n`
  );
