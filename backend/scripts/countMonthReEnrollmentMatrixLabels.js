...
const main = async () => {
  ...
  const payload = {
    ...
    dashboard_mapping: {
      ...
      note:
        'Rate denominator = prior-month new + re-enrolled + rejoin + upsell + completed-with-prior-history. Rate numerator = re-enrolled + Active (completed excluded; Inactive excluded).',
    },
    cells: detailRows,
  };
